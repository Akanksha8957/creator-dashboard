...
export default function CreatorStats({ totalFollowers, engagementRate, avgLikes }: CreatorStatsProps) {
    return (
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            ...
            <Card>
                <div className="flex items-center">
                    ...
                    <div className="ml-5">
                        <p className="text-sm font-medium text-slate-500 uppercase tracking-wide">Engagement Rate</p>
            ...
            <Card>
                <div className="flex items-center">
                    ...
                    <div className="ml-5">
                        <p className="text-sm font-medium text-slate-500 uppercase tracking-wide">Avg. Likes</p>
                        <p className="text-3xl font-bold text-slate-900 mt-1">{avgLikes.toLocaleString()}</p>
                    </div>
                </div>
            </Card>
        </div>
